...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@Security/Collector/security.html.twig", "/Users/user/Documents/project/docker/backend/vendor/symfony/security-bundle/Resources/views/Collector/security.html.twig");
    }
}
